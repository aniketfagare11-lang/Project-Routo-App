...
class _PrivacySecurityScreenState extends State<PrivacySecurityScreen> with TickerProviderStateMixin {
        ...
        SafeArea(
          child: ListView(
            ...
            children: [
              ...
              _buildToggleTile('Biometric Access', 'Use Face ID or Touch ID', true, Icons.fingerprint_rounded, _C.accentA),
              const SizedBox(height: 12),
              _buildToggleTile('Two-Factor Auth', 'Secure with OTP & codes', false, Icons.verified_user_rounded, _C.accentC),
              const SizedBox(height: 12),
              _buildActionTile('Change Password', 'Update your login credentials', Icons.lock_reset_rounded, _C.accentB),
              const SizedBox(height: 32),
              _buildSectionHeader('Data & Privacy'),
              const SizedBox(height: 16),
              _buildToggleTile('Location History', 'Track active route in background', true, Icons.map_rounded, _C.accentA),
              const SizedBox(height: 12),
              _buildToggleTile('Personalized Ads', 'Allow data sharing for better deals', false, Icons.privacy_tip_rounded, _C.accentC),
  ...
  PreferredSizeWidget _buildAppBar(BuildContext context) {
    return AppBar(
      ...
      title: const Text('Privacy & Security', style: TextStyle(color: Colors.white, fontWeight: FontWeight.w800, fontSize: 18)),
      actions: [
    ...
    return AnimatedBuilder(
      ...
      builder: (_, __) {
        ...
        return Stack(children: [
          ...
          _orb(x: 0.12 + 0.05 * math.cos(t),       y: 0.15 + 0.08 * math.sin(t),       size: 300, color: _C.accentA.withValues(alpha: 0.08)),
  ...
  Widget _buildToggleTile(String title, String subtitle, bool val, IconData icon, Color color) {
    return ClipRRect(
      ...
      child: BackdropFilter(
        ...
        child: Container(
          ...
          padding: const EdgeInsets.all(20),
          child: Row(children: [
            Container(padding: const EdgeInsets.all(12), decoration: BoxDecoration(color: color.withValues(alpha: 0.12), borderRadius: BorderRadius.circular(14)), child: Icon(icon, color: color, size: 22)),
            ...
            Switch(
              ...
              activeThumbColor: _C.green, activeTrackColor: _C.green.withValues(alpha: 0.25),
              inactiveThumbColor: Colors.white30, inactiveTrackColor: Colors.white12,
            ),
          ]),
        ),
      ),
      ...
      child: BackdropFilter(
        ...
        child: Container(
          ...
          child: ListTile(
            ...
            leading: Container(padding: const EdgeInsets.all(12), decoration: BoxDecoration(color: color.withValues(alpha: 0.12), borderRadius: BorderRadius.circular(14)), child: Icon(icon, color: color, size: 22)),
            title: Text(title, style: const TextStyle(color: Colors.white, fontWeight: FontWeight.w700, fontSize: 15)),
            subtitle: Text(subtitle, style: TextStyle(color: Colors.white.withValues(alpha: 0.4), fontSize: 12, fontWeight: FontWeight.w500)),
